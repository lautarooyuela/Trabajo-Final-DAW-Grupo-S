...
export class CrearClienteDto {
  ...
  @ApiProperty({ description: 'Teléfono del cliente en formato E.164', example: '+34912345678' })
...
export class EditarClienteDto {
  @ApiPropertyOptional({ description: 'Nombre del cliente', example: 'Juan Pérez' })
  @IsOptional()
  @IsString()
  @MinLength(1, { message: 'El nombre es requerido' })
  nombre?: string;
  ...
  @ApiPropertyOptional({ description: 'Teléfono del cliente en formato E.164', example: '+34912345678' })
  @IsOptional()
  @Matches(/^\+\d{7,15}$/, { message: 'El teléfono debe estar en formato E.164 (ej: +34912345678)' })
  telefono?: string;
